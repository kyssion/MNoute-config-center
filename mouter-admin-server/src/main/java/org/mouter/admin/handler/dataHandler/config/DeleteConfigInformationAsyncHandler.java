...
public class DeleteConfigInformationAsyncHandler extends AsyncSampleFnHandler {
    ...
    public static String SQL_DATA_KEY = "data.delete.config_data";
    public static String SQL_DATA_RESULT_KEY = "data.delete.application.config_data";
    ...
    public void asyncHandle(ParamWrapper paramWrapper, AsyncResult asyncResult, AsyncScheduler asyncScheduler) {
        MysqlPool.mysql.getConnection((res)->{
            if(res.succeeded()){
                ...
                connection.preparedQuery("delete from config_app_data where group_id=? and app_id=? and app_data_id=?")
